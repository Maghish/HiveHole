...
import LoginFunc from "@/components/serverComponents/LoginFunc";
...
function LoginForm({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center">
      <form className="relative max-w-[300px] sm:max-w-[400px] w-[300px] sm:w-[400px] max-h-[500px] sm:max-h-[560px] h-[500px] sm:h-[560px] bg-SecondaryBackgroundColor rounded-2xl shadow-FormModal flex flex-col px-6 sm:px-12 py-6 sm:py-10">
        <IoMdClose
